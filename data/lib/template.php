...
private function get_template_contents() { 
	...
	if (file_exists(SITE_PATH . '/data/tpl/' . $this->route . '.tpl')) { 
	...
	} elseif (file_exists(SITE_PATH . '/data/tpl/404.tpl')) { 
		$tpl_body = file_get_contents(SITE_PATH . '/data/tpl/404.tpl');
		...
		echo "Template does not exist: $this->route and no 404.tpl template file exists.";
		exit(0);
	}
